...
<div class="container">
    <div class="product-box">
      <img class="product-image" src="../img/wolf.jpg" alt="Awesome Widget">
      <div class="product-info">
        <div class="product-description">
          <h2>Multi Vitaminico Zoo</h2>
            <p>O Multi vitaminico é essencial para você manter suas vitaminas em seu dia a dia</p>
            <div class="product-price">R$80,99</div>
            <form action="../carrinho/comprar.php" method="post">
                <input type="hidden" name="iditem" value="2">
                <input type="hidden" name="nome" value="Multi Nacional Zoo">
                <input type="hidden" name="preco" value="45.99">
