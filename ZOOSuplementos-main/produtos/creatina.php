...
<div class="container">
    <div class="product-box">
        <img class="product-image" src="../img/crea.jpg" alt="Awesome Widget">
        <div class="product-info">
            <div class="product-description">
                <h2>Creatina Zoo</h2>
                <p>Experimente nossa creatina e potencialize seus resultados e transforme seu físico agora!</p>
            </div>
            <div class="product-price">R$80,99</div>
            <form action="../carrinho/comprar.php" method="post">
                <input type="hidden" name="iditem" value="9">
                <input type="hidden" name="nome" value="Creatina Zoo">
                <input type="hidden" name="preco" value="80.99">
