...
<header>
    ...
    <div class="product-box">
      <img class="product-image" src="../img/rino.jpg" alt="Awesome Widget">
      <div class="product-info">
        <div class="product-description">
          <h2>Pré-Treino Zoo</h2>
          <p>Experimente nosso Pré-Treino e maximaze seus resultados e diga adeus a seu cansaço !</p>
          <div class="product-price">R$100,99</div>
            <form action="../carrinho/comprar.php" method="post">
                <input type="hidden" name="iditem" value="4">
                <input type="hidden" name="nome" value="Pré Treino Zoo">
                <input type="hidden" name="preco" value="100.99">
